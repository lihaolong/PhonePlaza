...
public class ZealerUrlDAO {
	...
	private static String queryNew = "select url,title from zealerurl order by postid desc limit 1";
	...
	public JSONObject queryNewZealer() throws SQLException, JSONException{
